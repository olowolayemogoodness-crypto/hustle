...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  final List<_OnboardingPage> _pages = const [
    _OnboardingPage(
      imagePath: 'assets/images/man illustration.png', // map + worker illustration
    ...
    _OnboardingPage(
      imagePath: 'assets/images/save_coin.png', // safe + coins illustration
    ...
    _OnboardingPage(
      imagePath: 'assets/images/rating.png', // star trophy illustration
  ...
  Future<void> _alreadyHaveAccount() async {
    await SecureStorage.markOnboardingSeen();
    if (mounted) context.go(Routes.phoneAuth);
  }
